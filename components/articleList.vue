<template>
  <div class="content">
    <div class="content-list" v-for="(item,index) in articleList.data" :key="index" @click="goDetail(item)">
    ...
    <div class="page">
      <Page :total="articleList.total_items" :page-size="10" size="small" next-text="下一页" @on-change="getMoreArt" />
    </div>
  </div>
</template>
<script>
